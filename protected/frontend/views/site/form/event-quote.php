...
?>
		...
		<section class="white-bg">
			...
			<div class="container pb-100">
		        ...
		        <!--begin::Form-->
		        <?php $form = ActiveForm::begin(['id' => 'form-event-quote', 'options' => ['data-parsley-validate' => true]]); ?>
					<input type="hidden" name="newsletter-isMauritian" value="">
					<input type="hidden" name="newsletter-type" value="">
		        	<input type="hidden" name="quote-hotel" value="<?= isset($hotel) ? $hotel->name : '' ?>">
						...
						<div class="flex-1">
							...
							<div class="mb-20 pb-10">
								<label>
									...
									<input type="text" name="quote-people" placeholder="<?= Yii::t('app', "Ajouter un nombre") ?>" class="full-width border-1-light gray-text fs-15">
								</label>
							</div>
							<div class="mb-20 pb-10">
								<label class="flex">
									<span class="left-aligned fs-15"><?= Yii::t('app', "Inclure l'hébergement pour mon événement") ?></span>
									<input type="checkbox" id="show-extra-input-blocks" name="quote-include-accomodation" value="<?= Yii::t('app', "Oui") ?>">
									<span class="checkbox"></span>
								</label>
							</div>
