...
?>
	...
	<tr>
		<td valign="top" style="font-size: 18px; letter-spacing: 0.15em; line-height: 26px; text-transform: uppercase;">Vérification de votre email</td>
	</tr>
	<tr>
	...
	<tr>
		<td valign="top" style="padding-top: 10px; font-size: 16px; font-style: italic; line-height: 24px;">
			Cliquez sur le lien ci-dessous pour vérifier votre email :<br>
