...
$baseUrl = str_replace('backend', '', Url::base(true)); ?>
    ...
    <div class="col-lg-12 block <?= !$show ? 'block-widget' : '' ?> block-next-events my-10" data-block="next-events" data-init="select2" <?= $show ? 'data-idx="'.($idx+1).'"' : '' ?>>
        ...
        <div class="block-unit bg-gray-100 p-5 border-light-dark rounded">
            <h3 class="text-primary text-uppercase">Prochains événements</h3>
