...
$baseUrl = str_replace('backend', '', Url::base(true)); ?>
    ...
    <div class="col-lg-12 block <?= !$show ? 'block-widget' : 'init-summernote' ?> block-title-subtitle-cta my-10" data-block="title-subtitle-cta" data-init="summernote" <?= $show ? 'data-idx="'.($idx+1).'"' : '' ?>>
        ...
        <div class="block-unit bg-gray-100 p-5 border-light-dark rounded">
            <h3 class="text-primary text-uppercase">Titre, sous-titre & bouton</h3>
            <div class="separator separator-dashed border-light-dark my-4"></div>

            <div class="form-group">
                <label class="mb-0">Photo : 
                ...
                <div class="mt-3 text-center card-body rounded border-light-dark p-0 content-media">
                    ...
                    <div class="row draggable-zone draggable-max p-5" data-draggable-max="1">
                        <p class="content-photo-msg m-5 text-center" <?= isset($dataArr['photo']) && $dataArr['photo'] != '[]' ? 'style="display: none"' : '' ?>>Glisser-déposer une photo/vidéo provenant de la bibliothèque</p>
            ...
            <div class="form-group">
                ...
                <div class="summernote summernote-box"><?= isset($dataArr['subtitle']) ? $dataArr['subtitle'] : '' ?></div>
            </div>
            <div class="form-group">
                <label>Lien :</label>
