...
$baseUrl = str_replace('backend', '', Url::base(true)); ?>
    ...
    <div class="col-lg-12 block <?= !$show ? 'block-widget' : '' ?> block-big-title my-10" data-block="big-title" <?= $show ? 'data-idx="'.($idx+1).'"' : '' ?>>
        ...
        <div class="block-unit bg-gray-100 p-5 border-light-dark rounded">
            <h3 class="text-primary text-uppercase">Gros titre</h3>
