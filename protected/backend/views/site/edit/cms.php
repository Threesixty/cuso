...
?>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <!--begin::Form-->
        <?php $form = ActiveForm::begin(['id' => 'form-edit-cms']); ?>
                ...
                <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                    ...
                    <div class="d-flex align-items-center flex-wrap mr-1">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                            <!--begin::Page Title-->
                            <h5 class="text-white font-weight-bold my-1 mr-5"><?= MainHelper::getPageTitle($model->title, 'Ajouter un contenu') ?></h5>
                    ...
                    <div class="card-toolbar">
                        <a href="<?= Url::to(['site/cms']) ?>" class="btn btn-light-dark font-weight-bolder mr-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                $tplOption = Option::getOption('name', 'cms-template', 'select');
                                                ...
                                                <?= $form->field($model, 'template', ['options' => ['tag' => false]])
                                                    ->dropDownList(
                                                        ...
                                                        [
                                                            ...
                                                            'data-placeholder' => 'Sélectionnez un modèle',
                                                        ]
                                                    )
                                                    ->label(false) ?>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <?= $form->field($model, 'tags', ['options' => ['tag' => false]])
                                                    ->dropDownList(
                                                        $tags, 
                                                        [
