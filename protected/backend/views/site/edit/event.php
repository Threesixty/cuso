                                                                    ...
                                                                    foreach ($model->participantList as $participant) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td nowrap="nowrap" class="text-center">
                                                                                <a href="javascript:void(0)" class="btn btn-sm btn-clean btn-icon participant-action <?= !in_array($participant->registered, [0, 2]) ? 'd-none' : '' ?>" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Valider" data-action="register">
                                                                                    <i class="la la-plus-circle"></i>
                                                                                </a>
                                                                                <a href="javascript:void(0)" class="btn btn-sm btn-clean btn-icon participant-action <?= !in_array($participant->registered, [0, 1]) ? 'd-none' : '' ?>" data-toggle="tooltip" data-placement="left" data-container="body" data-boundary="window" title="Refuser" data-action="refuse">
