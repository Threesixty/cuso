        ...
        foreach ($eventParticipantList as $participant) {
            ...
            <tr>
                ...
                <td nowrap="nowrap" class="text-center">
                    <a href="javascript:void(0)" class="btn btn-sm btn-clean btn-icon participant-action new-row" data-toggle="tooltip" data-placement="left" data-container="body" data-boundary="window" title="<?= $participant->registered ? Yii::t('app', "Désinscrire") : Yii::t('app', "Inscrire") ?>" data-action="register">
                        <i class="la la-<?= $participant->registered ? 'minus-circle' : 'plus-circle' ?>"></i>
                    </a>
                    <?php
                    if (null === $participant->came || !$participant->came) { ?>
                        <a href="javascript:void(0)" class="btn btn-sm btn-clean btn-icon participant-action new-row" data-toggle="tooltip" data-placement="bottom" data-container="body" data-boundary="window" title="<?= Yii::t('app', "A participé") ?>" data-action="came">
                            <i class="la la-user-check"></i>
                        </a>
                    <?php }
                    if (null === $participant->came || $participant->came) { ?>
                        <a href="javascript:void(0)" class="btn btn-sm btn-clean btn-icon participant-action new-row" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="<?= Yii::t('app', "Absent") ?>" data-action="notcame">
